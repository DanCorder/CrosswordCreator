...
export default function Credits() {
  return (
    <Overlay linkText="Credits">
      <h2>Credits/Copyright</h2>
      <div className="content-section">
        <h3>This Website</h3>
        <p>
          This website was created by Dan Corder.{' '}
          <a
          ...
          <a
            href="https://github.com/DanCorder/CrosswordCreator/blob/main/LICENSE.txt"
            target="_blank"
            rel="noreferrer"
          >
            GPL3 licence
          </a>{' '}
          on Github so you can run your own version or make customisations.
        </p>
      </div>
      <div className="content-section">
        <h3>Word List</h3>
        <p>
          The word list used by this site comes from{' '}
          <a href="http://app.aspell.net/create" target="_blank" rel="noreferrer">
