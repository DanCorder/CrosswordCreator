...
var app = (function () {
    ...
    // (14:20) {#each row as cell, columnIndex}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			attr_dev(td, "class", td_class_value = "cell " + (/*cell*/ ctx[6].IsWhite ? "white" : "black") + " svelte-11j854n");
    			add_location(td, file$5, 14, 24, 559);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*grid*/ 1 && td_class_value !== (td_class_value = "cell " + (/*cell*/ ctx[6].IsWhite ? "white" : "black") + " svelte-11j854n")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:20) {#each row as cell, columnIndex}",
    		ctx
    	});
    ...
    // (12:12) {#each grid.Cells as row, rowIndex}
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$5, 12, 16, 475);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:12) {#each grid.Cells as row, rowIndex}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file$5, 10, 8, 401);
    			attr_dev(table, "class", "grid svelte-11j854n");
    			add_location(table, file$5, 9, 4, 371);
    			attr_dev(div, "class", "content-block");
    			add_location(div, file$5, 8, 0, 338);
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function cellClickHandler(rowIndex, columnIndex) {
    		...
    		$$invalidate(0, grid.Cells[rowIndex][columnIndex].IsWhite = !grid.Cells[rowIndex][columnIndex].IsWhite, grid);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 16, 8, 524);
    			attr_dev(a0, "href", "https://www.wordplays.com/anagrammer");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file, 19, 16, 621);
    			add_location(li0, file, 19, 12, 617);
    			attr_dev(a1, "href", "https://www.dictionary.com/");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 20, 16, 718);
    			add_location(li1, file, 20, 12, 714);
    			attr_dev(a2, "href", "https://www.thesaurus.com/");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file, 21, 16, 813);
    			add_location(li2, file, 21, 12, 809);
    			attr_dev(a3, "href", "https://puzzling.stackexchange.com/questions/45984/cryptic-clue-guide|");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file, 22, 16, 906);
    			add_location(li3, file, 22, 12, 902);
    			attr_dev(a4, "href", "https://en.wikipedia.org/wiki/Crossword_abbreviations");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file, 23, 16, 1049);
    			add_location(li4, file, 23, 12, 1045);
    			add_location(ul, file, 18, 8, 600);
    			attr_dev(div0, "class", "content-block");
    			add_location(div0, file, 15, 4, 488);
    			attr_dev(a5, "href", "/CrosswordCreator/credits");
    			add_location(a5, file, 34, 8, 1293);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file, 33, 4, 1257);
    			attr_dev(div2, "class", "main");
    			add_location(div2, file, 14, 0, 465);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
