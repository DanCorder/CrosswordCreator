...
var app = (function () {
    ...
    //   [ [ "kolo" ] ]
    // ]
    function findAnagrams(letters, anagramList, minimumWordLength = 3, excludedWords = [], maxResults = 1000, ignoreWeirdSingleLetters = true) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div.textContent = "No results";
    			attr_dev(div, "class", "no-results svelte-19au53g");
    			add_location(div, file$1, 62, 12, 2381);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:8) {#if results.length > 0}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const result_changes = {};
    			if (dirty & /*results*/ 1) result_changes.result = /*result*/ ctx[13];
    			result.$set(result_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:12) {#each results as result}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if_block.c();
    			add_location(h2, file$1, 31, 4, 1009);
    			add_location(input, file$1, 33, 8, 1048);
    			option0.__value = 1;
    			option0.value = option0.__value;
    			add_location(option0, file$1, 36, 12, 1197);
    			option1.__value = 2;
    			option1.value = option1.__value;
    			add_location(option1, file$1, 37, 12, 1238);
    			option2.__value = 3;
    			option2.value = option2.__value;
    			add_location(option2, file$1, 38, 12, 1279);
    			option3.__value = 4;
    			option3.value = option3.__value;
    			add_location(option3, file$1, 39, 12, 1320);
    			option4.__value = 5;
    			option4.value = option4.__value;
    			add_location(option4, file$1, 40, 12, 1361);
    			option5.__value = 6;
    			option5.value = option5.__value;
    			add_location(option5, file$1, 41, 12, 1402);
    			option6.__value = 7;
    			option6.value = option6.__value;
    			add_location(option6, file$1, 42, 12, 1443);
    			option7.__value = 8;
    			option7.value = option7.__value;
    			add_location(option7, file$1, 43, 12, 1484);
    			option8.__value = 9;
    			option8.value = option8.__value;
    			add_location(option8, file$1, 44, 12, 1525);
    			option9.__value = 10;
    			option9.value = option9.__value;
    			add_location(option9, file$1, 45, 12, 1566);
    			option10.__value = 11;
    			option10.value = option10.__value;
    			add_location(option10, file$1, 46, 12, 1609);
    			option11.__value = 12;
    			option11.value = option11.__value;
    			add_location(option11, file$1, 47, 12, 1652);
    			option12.__value = 13;
    			option12.value = option12.__value;
    			add_location(option12, file$1, 48, 12, 1695);
    			option13.__value = 14;
    			option13.value = option13.__value;
    			add_location(option13, file$1, 49, 12, 1738);
    			option14.__value = 15;
    			option14.value = option14.__value;
    			add_location(option14, file$1, 50, 12, 1781);
    			if (/*minimumWordLength*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[9].call(select));
    			add_location(select, file$1, 35, 8, 1145);
    			add_location(p0, file$1, 32, 4, 1036);
    			add_location(button0, file$1, 53, 7, 1846);
    			add_location(p1, file$1, 53, 4, 1843);
    			add_location(button1, file$1, 54, 7, 2008);
    			add_location(p2, file$1, 54, 4, 2005);
    			add_location(textarea, file$1, 55, 7, 2133);
    			add_location(p3, file$1, 55, 4, 2130);
    			add_location(div0, file$1, 56, 4, 2220);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$1, 30, 0, 977);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*excludedWords*/ ctx[3]);
    			append_dev(p3, t25);
    			append_dev(div1, t26);
    			append_dev(div1, div0);
    			if_blocks[current_block_type_index].m(div0, null);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "keydown", /*handleKeyDownAll*/ ctx[6], false, false, false),
    					listen_dev(select, "change", /*select_change_handler*/ ctx[9]),
    					listen_dev(button0, "click", /*findSingleWordAnagrams*/ ctx[4], false, false, false),
    					listen_dev(button1, "click", /*findAllAnagrams*/ ctx[5], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function findSingleWordAnagrams() {
    		...
    		$$invalidate(0, results = findAllSingleWordAnagrams(letters, anagramList, minimumWordLength, excludedWords));
    	}
    	...
    	function findAllAnagrams() {
    		...
    		$$invalidate(0, results = findAnagrams(letters, anagramList, minimumWordLength, excludedWords));
    	}
    	...
    	function textarea_input_handler() {
    		excludedWords = this.value;
    		($$invalidate(3, excludedWords), $$invalidate(12, excludedWordsString));
    	}

    	$$self.$$set = $$props => {
    		if ('wordList' in $$props) $$invalidate(7, wordList = $$props.wordList);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('excludedWordsString' in $$props) $$invalidate(12, excludedWordsString = $$props.excludedWordsString);
    		if ('excludedWords' in $$props) $$invalidate(3, excludedWords = $$props.excludedWords);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*wordList*/ 128) {
    			anagramList = !wordList ? null : createAnagramList(wordList);
    		}
    	};

    	$$invalidate(3, excludedWords = excludedWordsString.split("\n"));
    ...
    class Anagrams extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { wordList: 7 });
    		...
    		if (/*wordList*/ ctx[7] === undefined && !('wordList' in props)) {
