...
var app = (function () {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h30, file$6, 11, 4, 276);
    			attr_dev(a0, "href", "https://github.com/DanCorder/CrosswordCreator/");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$6, 12, 47, 345);
    			attr_dev(a1, "href", "https://github.com/DanCorder/CrosswordCreator/blob/main/LICENSE.txt");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$6, 12, 158, 456);
    			add_location(p0, file$6, 12, 4, 302);
    			add_location(h31, file$6, 14, 4, 642);
    			attr_dev(a2, "href", "http://app.aspell.net/create");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$6, 15, 50, 711);
    			add_location(p1, file$6, 15, 4, 665);
    			attr_dev(a3, "href", "http://wordlist.aspell.net/");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$6, 48, 0, 2234);
    			add_location(pre, file$6, 16, 4, 837);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$6, 7, 4, 139);
    			attr_dev(p, "class", "link svelte-7yshu2");
    			add_location(p, file$6, 8, 4, 170);
    			attr_dev(div, "class", "content-block");
    			add_location(div, file$6, 6, 0, 107);
    		},
    ...
    // (84:28) {#if cell.IsWhite}
    function create_if_block$2(ctx) {
    	let div2;
    	let div0;
    	let t0_value = (/*cell*/ ctx[16].CellNumber ?? "") + "";
    	let t0;
    	let t1;
    	let div1;
    	let t2_value = /*cell*/ ctx[16].AnswerLetter + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(t2_value);
    			attr_dev(div0, "class", "cell-number svelte-3m4qeq");
    			add_location(div0, file$5, 85, 36, 3210);
    			attr_dev(div1, "class", "cell-letter svelte-3m4qeq");
    			add_location(div1, file$5, 88, 36, 3383);
    			attr_dev(div2, "class", "cell-layout svelte-3m4qeq");
    			add_location(div2, file$5, 84, 32, 3147);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*grid*/ 2 && t0_value !== (t0_value = (/*cell*/ ctx[16].CellNumber ?? "") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*grid*/ 2 && t2_value !== (t2_value = /*cell*/ ctx[16].AnswerLetter + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    ...
    // (77:20) {#each row as cell, columnIndex}
    function create_each_block_1$1(ctx) {
    	let td;
    	let td_class_value;
    	let rowIndex = /*rowIndex*/ ctx[15];
    	let columnIndex = /*columnIndex*/ ctx[18];
    	let mounted;
    	let dispose;
    	let if_block = /*cell*/ ctx[16].IsWhite && create_if_block$2(ctx);

    	function focus_handler() {
    		return /*focus_handler*/ ctx[7](/*rowIndex*/ ctx[15], /*columnIndex*/ ctx[18]);
    	}

    	function keydown_handler(...args) {
    		return /*keydown_handler*/ ctx[8](/*rowIndex*/ ctx[15], /*columnIndex*/ ctx[18], ...args);
    	}

    	const assign_td = () => /*td_binding*/ ctx[9](td, rowIndex, columnIndex);
    	const unassign_td = () => /*td_binding*/ ctx[9](null, rowIndex, columnIndex);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td, "class", td_class_value = "cell " + (/*cell*/ ctx[16].IsWhite ? "white" : "black") + " svelte-3m4qeq");
    			add_location(td, file$5, 78, 24, 2719);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*grid*/ 2 && td_class_value !== (td_class_value = "cell " + (/*cell*/ ctx[16].IsWhite ? "white" : "black") + " svelte-3m4qeq")) {
    				attr_dev(td, "class", td_class_value);
    			}

    			if (rowIndex !== /*rowIndex*/ ctx[15] || columnIndex !== /*columnIndex*/ ctx[18]) {
    				unassign_td();
    				rowIndex = /*rowIndex*/ ctx[15];
    				columnIndex = /*columnIndex*/ ctx[18];
    				assign_td();
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(77:20) {#each row as cell, columnIndex}",
    		ctx
    	});
    ...
    // (75:12) {#each grid.Cells as row, rowIndex}
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$5, 75, 16, 2572);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*grid, cells, cellFocusHandler, cellKeyDownHandler*/ 30) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:12) {#each grid.Cells as row, rowIndex}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$5, 55, 12, 1805);
    			option1.__value = 2;
    			option1.value = option1.__value;
    			add_location(option1, file$5, 56, 12, 1847);
    			option2.__value = 3;
    			option2.value = option2.__value;
    			add_location(option2, file$5, 57, 12, 1889);
    			option3.__value = 4;
    			option3.value = option3.__value;
    			add_location(option3, file$5, 58, 12, 1931);
    			option4.__value = 5;
    			option4.value = option4.__value;
    			add_location(option4, file$5, 59, 12, 1973);
    			option5.__value = 6;
    			option5.value = option5.__value;
    			add_location(option5, file$5, 60, 12, 2015);
    			option6.__value = 7;
    			option6.value = option6.__value;
    			add_location(option6, file$5, 61, 12, 2057);
    			option7.__value = 8;
    			option7.value = option7.__value;
    			add_location(option7, file$5, 62, 12, 2099);
    			option8.__value = 9;
    			option8.value = option8.__value;
    			add_location(option8, file$5, 63, 12, 2141);
    			option9.__value = 10;
    			option9.value = option9.__value;
    			add_location(option9, file$5, 64, 12, 2183);
    			option10.__value = 11;
    			option10.value = option10.__value;
    			add_location(option10, file$5, 65, 12, 2227);
    			option11.__value = 12;
    			option11.value = option11.__value;
    			add_location(option11, file$5, 66, 12, 2271);
    			option12.__value = 13;
    			option12.value = option12.__value;
    			add_location(option12, file$5, 67, 12, 2315);
    			option13.__value = 14;
    			option13.value = option13.__value;
    			add_location(option13, file$5, 68, 12, 2359);
    			option14.__value = 15;
    			option14.value = option14.__value;
    			add_location(option14, file$5, 69, 12, 2403);
    			if (/*gridSize*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[6].call(select));
    			add_location(select, file$5, 54, 13, 1731);
    			add_location(p, file$5, 54, 4, 1722);
    			add_location(tbody, file$5, 73, 8, 2498);
    			attr_dev(table, "class", "grid svelte-3m4qeq");
    			add_location(table, file$5, 72, 4, 2468);
    			attr_dev(div, "class", "content-block");
    			add_location(div, file$5, 53, 0, 1689);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select, "change", /*sizeChangeHandler*/ ctx[5], false, false, false)
    				];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function td_binding($$value, rowIndex, columnIndex) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('currentCellRow' in $$props) currentCellRow = $$props.currentCellRow;
    		if ('currentCellColumn' in $$props) currentCellColumn = $$props.currentCellColumn;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 14, 8, 435);
    			attr_dev(a0, "href", "https://www.wordplays.com/anagrammer");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file, 16, 16, 531);
    			add_location(li0, file, 16, 12, 527);
    			attr_dev(a1, "href", "https://www.dictionary.com/");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 17, 16, 628);
    			add_location(li1, file, 17, 12, 624);
    			attr_dev(a2, "href", "https://www.thesaurus.com/");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file, 18, 16, 723);
    			add_location(li2, file, 18, 12, 719);
    			attr_dev(a3, "href", "https://puzzling.stackexchange.com/questions/45984/cryptic-clue-guide|");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file, 19, 16, 816);
    			add_location(li3, file, 19, 12, 812);
    			attr_dev(a4, "href", "https://en.wikipedia.org/wiki/Crossword_abbreviations");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file, 20, 16, 959);
    			add_location(li4, file, 20, 12, 955);
    			add_location(ul, file, 15, 8, 510);
    			attr_dev(div0, "class", "content-block");
    			add_location(div0, file, 13, 4, 399);
    			attr_dev(div1, "class", "main");
    			add_location(div1, file, 12, 0, 376);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
