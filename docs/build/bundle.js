    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 14, 4, 399);
    			add_location(p, file$3, 15, 4, 432);
    			add_location(input, file$3, 16, 4, 543);
    			add_location(button, file$3, 16, 35, 574);
    			add_location(div0, file$3, 17, 4, 625);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$3, 13, 0, 367);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 23, 7, 759);
    			add_location(p0, file$1, 23, 4, 756);
    			add_location(button1, file$1, 24, 7, 921);
    			add_location(p1, file$1, 24, 4, 918);
    			add_location(input, file$1, 25, 4, 1043);
    			add_location(div0, file$1, 26, 4, 1078);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$1, 21, 0, 697);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
