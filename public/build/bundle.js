...
var app = (function () {
    ...
    /* src/components/Result.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 14, 4, 396);
    			add_location(p, file$2, 15, 4, 429);
    			add_location(input, file$2, 16, 4, 540);
    			add_location(button, file$2, 16, 35, 571);
    			add_location(div0, file$2, 17, 4, 622);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$2, 13, 0, 364);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
