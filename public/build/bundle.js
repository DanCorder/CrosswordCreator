...
var app = (function () {
    ...
    const file$1 = "src/components/WordFit.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 13, 4, 346);
    			add_location(p, file$1, 14, 4, 379);
    			add_location(input, file$1, 15, 4, 490);
    			add_location(button, file$1, 15, 35, 521);
    			add_location(div0, file$1, 16, 4, 572);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$1, 12, 0, 314);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div4 = element("div");
    			h21 = element("h2");
    			h21.textContent = "Find Single Anagrams";
    			t25 = space();
    			p2 = element("p");
    			p2.textContent = "Find all single word anagrams within the input, not necessarily using all letters";
    			t27 = space();
    			...
    			add_location(h1, file, 14, 8, 416);
    			attr_dev(a0, "href", "https://www.wordplays.com/anagrammer");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file, 17, 16, 513);
    			add_location(li0, file, 17, 12, 509);
    			attr_dev(a1, "href", "https://www.dictionary.com/");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 18, 16, 610);
    			add_location(li1, file, 18, 12, 606);
    			attr_dev(a2, "href", "https://www.thesaurus.com/");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file, 19, 16, 705);
    			add_location(li2, file, 19, 12, 701);
    			attr_dev(a3, "href", "https://puzzling.stackexchange.com/questions/45984/cryptic-clue-guide|");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file, 20, 16, 798);
    			add_location(li3, file, 20, 12, 794);
    			attr_dev(a4, "href", "https://en.wikipedia.org/wiki/Crossword_abbreviations");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file, 21, 16, 941);
    			add_location(li4, file, 21, 12, 937);
    			add_location(ul, file, 16, 8, 492);
    			attr_dev(div0, "class", "content-block");
    			add_location(div0, file, 13, 4, 380);
    			add_location(h20, file, 28, 8, 1142);
    			add_location(p0, file, 29, 8, 1173);
    			add_location(p1, file, 30, 8, 1326);
    			attr_dev(input0, "id", "findAnagramsInput");
    			add_location(input0, file, 31, 8, 1365);
    			attr_dev(button0, "id", "findAnagramsButton");
    			add_location(button0, file, 31, 41, 1398);
    			attr_dev(input1, "id", "findAnagramsExclude");
    			add_location(input1, file, 31, 111, 1468);
    			attr_dev(div1, "id", "findAnagramsOutput");
    			add_location(div1, file, 32, 8, 1511);
    			attr_dev(div2, "class", "content-block");
    			add_location(div2, file, 27, 4, 1106);
    			add_location(h21, file, 36, 8, 1599);
    			add_location(p2, file, 37, 8, 1637);
    			attr_dev(input2, "id", "findSingleAnagramsInput");
    			add_location(input2, file, 38, 8, 1734);
    			attr_dev(button1, "id", "findSingleAnagramsButton");
    			add_location(button1, file, 38, 47, 1773);
    			attr_dev(div3, "id", "findSingleAnagramsOutput");
    			add_location(div3, file, 39, 8, 1835);
    			attr_dev(div4, "class", "content-block");
    			add_location(div4, file, 35, 4, 1563);
    			attr_dev(a5, "href", "/CrosswordCreator/credits");
    			add_location(a5, file, 43, 8, 1929);
    			attr_dev(div5, "class", "content-block");
    			add_location(div5, file, 42, 4, 1893);
    			attr_dev(div6, "class", "main");
    			add_location(div6, file, 12, 0, 357);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(li4, a4);
    			append_dev(div6, t11);
    			mount_component(wordfit, div6, null);
    			append_dev(div6, t12);
