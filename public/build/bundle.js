...
var app = (function () {
    ...
    // (19:8) {#each results as result}
    function create_each_block$2(ctx) {
    	let result;
    	let current;

    	result = new WordResult({
    			props: { result: /*result*/ ctx[5] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*results*/ 1) result_changes.result = /*result*/ ctx[5];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(19:8) {#each results as result}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 14, 4, 388);
    			add_location(p, file$3, 15, 4, 421);
    			add_location(input, file$3, 16, 4, 532);
    			add_location(button, file$3, 16, 35, 563);
    			add_location(div0, file$3, 17, 4, 614);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$3, 13, 0, 356);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class WordFit extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { wordList: 3 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 22, 4, 710);
    			add_location(button0, file$1, 23, 7, 740);
    			add_location(p0, file$1, 23, 4, 737);
    			add_location(button1, file$1, 24, 7, 902);
    			add_location(p1, file$1, 24, 4, 899);
    			add_location(input, file$1, 25, 4, 1024);
    			add_location(div0, file$1, 26, 4, 1059);
    			attr_dev(div1, "class", "content-block");
    			add_location(div1, file$1, 21, 0, 678);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
